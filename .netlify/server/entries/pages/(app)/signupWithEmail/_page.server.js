...
const actions = {
  default: async ({ request, fetch }) => {
    ...
    const formSchema = object({
      firstName: string().min(2, "too short").required("First name is required"),
      ...
      confirmPassword: string().required("please enter the same password").oneOf([ref("password")], "please enter the same password")
    });
    try {
