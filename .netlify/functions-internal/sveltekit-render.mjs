	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/capctha/_server.js')
			},
			{
				id: "/api/getPageData",
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/getPageData/_server.js')
			},
			{
				id: "/api/navFooter",
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/navFooter/_server.js')
			},
			{
				id: "/api/otpRecovery",
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/otpRecovery/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/recoveryPassword/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/recoveryemail/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/signupWithEmail/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/updateProfile/_server.js')
			},
			{
				id: "/api/verifyEmail",
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/verifyEmail/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/verifyPassword/_server.js')
			},
			{
