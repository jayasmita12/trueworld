...
<div class="col-span-3 flex items-center space-x-1 md:space-x-2">
  <!-- <p>{socialMediaLinks[0]?.address}</p> -->

  <!-- Linkedin -->
  <a href={socialMediaLinks[0]?.address} target="_blank" rel="noreferrer">
    <svg
      class="h-[1.563rem]"
  ...
  <a href={socialMediaLinks[1]?.address} target="_blank" rel="noreferrer">
    <svg
      ...
      <g id="IG" clip-path="url(#clip-IG)">
        <g
          id="Grupo_15222"
          data-name="Grupo 15222"
          transform="translate(20793.102 -8076.701)">
          <path
            id="Trazado_8528"
            data-name="Trazado 8528"
            d="M488.325,2.57h2.554a2.259,2.259,0,0,0,.307.065,19.456,19.456,0,0,1,8.874,2.822,20.169,20.169,0,0,1,9.662,14.025c.138.742.211,1.5.313,2.244v2.554a2.274,2.274,0,0,0-.066.309,20.424,20.424,0,0,1-23.1,18.667,20.475,20.475,0,0,1-17.6-22.3A19.723,19.723,0,0,1,474.284,9.5a20.017,20.017,0,0,1,11.837-6.619c.731-.127,1.47-.207,2.2-.308M501.4,23.013c-.073-1.938-.062-3.9-.241-5.842a5.968,5.968,0,0,0-3.562-5.156,7.3,7.3,0,0,0-3.018-.66c-2.766-.039-5.532-.073-8.3-.062a18,18,0,0,0-3.017.231,5.852,5.852,0,0,0-4.863,4.084,8.248,8.248,0,0,0-.429,2.38c-.072,2.778-.078,5.559-.08,8.338a25,25,0,0,0,.147,2.547,6.079,6.079,0,0,0,5.288,5.609,31.409,31.409,0,0,0,4.454.235c2.552,0,5.111.013,7.654-.165a6.08,6.08,0,0,0,5.732-5.744c.16-1.919.16-3.851.233-5.8"
            transform="translate(-21260.703 8076.131)"
            class="fill-base-200" />
          <path
            id="Trazado_8529"
            data-name="Trazado 8529"
            d="M567.58,111.522c.052-1.8.059-3.571.165-5.335a4.079,4.079,0,0,1,4.153-4.143q5.319-.141,10.644,0a4.022,4.022,0,0,1,4.176,4.19c.1,3.559.082,7.125-.008,10.685a3.845,3.845,0,0,1-2.758,3.808,7.409,7.409,0,0,1-2.192.349c-3.018.038-6.037.044-9.054,0a7.436,7.436,0,0,1-2.376-.421,3.907,3.907,0,0,1-2.577-3.737c-.119-1.8-.121-3.613-.172-5.389m15.678.007a6.021,6.021,0,1,0-6.047,6.015,6.01,6.01,0,0,0,6.047-6.015m1.645-6.285a1.4,1.4,0,1,0-1.367,1.416,1.4,1.4,0,0,0,1.367-1.416"
            transform="translate(-21348.379 7987.61)"
            class="fill-base-200" />
          <path
            id="Trazado_8530"
            data-name="Trazado 8530"
            d="M624,161.311a3.91,3.91,0,1,1,3.9-3.913,3.918,3.918,0,0,1-3.9,3.913"
            transform="translate(-21395.127 7941.731)"
            class="fill-base-200" />
        </g>
      </g>
    </svg>
  ...
  <!-- Facebook -->
  <a href={socialMediaLinks[2]?.address} target="_blank" rel="noreferrer">
    <svg
      class="h-[1.563rem]"
      xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <g id="facebook" clip-path="url(#clip-facebook)">
        <path
          id="Trazado_8532"
          data-name="Trazado 8532"
          d="M978.133,21.883v2.4c-.023.128-.051.256-.07.384-.155,1.014-.222,2.051-.475,3.04A20.215,20.215,0,0,1,963.8,42.624c-1.174.4-2.422.6-3.666.893V27.352h4.911l.741-5.725h-5.661c0-1.425-.021-2.8.014-4.174a2.906,2.906,0,0,1,.3-1.15,2.021,2.021,0,0,1,1.89-1.065c1.066-.053,2.136-.04,3.2-.058.141,0,.281-.014.446-.022,0-1.648,0-3.249-.012-4.851a.4.4,0,0,0-.277-.268c-1.614-.072-3.23-.2-4.842-.16a6.641,6.641,0,0,0-4.235,1.575,6.857,6.857,0,0,0-2.367,5.118c-.081,1.519-.044,3.044-.06,4.567,0,.155,0,.311,0,.511h-4.91v5.734h4.888V43.255a.4.4,0,0,1-.1.021,1.55,1.55,0,0,1-.158-.025,20.377,20.377,0,0,1-8.859-3.976,20.031,20.031,0,0,1-6.742-9.26,20.176,20.176,0,0,1,.29-14.633,20.563,20.563,0,0,1,18.268-12.8A19.922,19.922,0,0,1,967.3,5.012a20.208,20.208,0,0,1,10.512,14.54c.146.769.214,1.553.318,2.331"
          transform="translate(-935.603 -0.57)"
          class="fill-base-200" />
      </g>
    </svg>
  </a>
  <!-- Twitter -->
  <a href={socialMediaLinks[3]?.address} target="_blank" rel="noreferrer">
    <svg
      class="h-[1.563rem]"
      xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <p class="hidden lg:block text-tw-4 xl:text-base font-medium">Follow us</p>
</div>
